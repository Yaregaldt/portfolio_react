    ...
    return (
      <div className='hero'>
        ...
        <main class="hero-area">
            <div class="hero-text">
                <h1>Yaregal Tilahun</h1>
                <p>Web Developer</p>
                <div class="button"><a href="#about-me">About me</a></div>
            </div>
            <aside class="socials">
                 <div><a href="https://www.github.com/yaregaldt" target="_blank" class="social" alt="my github repo link" rel="noreferrer">
                ...
                <div><a href="https://www.linkedin.com/in/yaregal-d-tilahun-903a58215/" target="_blank" class="social" alt="my linkedin profile link" rel="noreferrer">
